...
namespace AutoCharacterSheet
{
    public partial class Form1 : Form
    {
        ...
        void updateMaxHP(object sender, EventArgs e)
        {
            MaxHP = (int)Numeric_PH_Base.Value * 4 + (int)Numeric_WIL_Base.Value * 2 + (int)numeric_BaseHP.Value + ((int)Numeric_HPpLVL.Value * (int)Numeric_Level.Value);
            label_Max_HP_Display.Text = MaxHP.ToString();
